...
class Local_samplenet(nn.Module):
    def __init__(self,num_class ,
        ...
        self.sa1 = PointNetSetAbstraction( num_in_point = num_in_point, npoint=self.npatch, radius=0.2, nsample=self.nsample_per_patch, in_channel1=in_channel,in_channel2=self.bottleneck_size , mlp=[64, 64,64,128,self.bottleneck_size],mlp2=[256, 256, 256, 3*int(self.npoint_per_patch)], group_all=False, knn=True, trans_norm=trans_norm, scale_norm=scale_norm,use_xyz=False,use_nchw=True,global_fetuers=global_fetuers,seed_choice=seed_choice, batch_size=batch_size )
    ...
    def forward(self, xyz):
        ...
        return projected_points, end_points
