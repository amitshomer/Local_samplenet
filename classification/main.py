...
def options(argv=None, parser=None):
    ...
    parser.add_argument('-o', '--outfile', required=False, type=str, default='log/baseline/PCRNet1024', \
                        metavar='BASENAME', help='output filename (prefix)')  # the result: ${BASENAME}_model_best.pth
    parser.add_argument('--datafolder', required=False, default='/home/amit/Documents/sampleNet_stand_alone/SampleNet/registration/data/car_hdf5_2048', \
    ...
    parser.add_argument('--sampler', required=False, default='samplenet', choices=['fps', 'samplenet', 'random', 'none'], type=str,
